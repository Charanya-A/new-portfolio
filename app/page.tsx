  ...
  return (
    <section className="min-h-screen flex flex-col justify-center">
      <div className="space-y-6">
        ...
        <h1 className="text-6xl font-bold leading-tight sm:pl-14 md:pl-16">
          <span className="text-gray-200">Full Stack</span> <br />
          <span className="text-gray-400">AI Developer</span>
        </h1>

        {/* Paragraphs shifted to right, justified, and stretched wider */}
        <div className="text-lg text-gray-300 space-y-3 ml-[24px] max-w-3xl text-justify sm:pl-8 md:pl-10">
          <p>
