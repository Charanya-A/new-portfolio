  ...
  return (
    <div className="w-full space-y-10">
      ...
      <p className="text-gray-300">
        Here are some of the projects I&rsquo;ve worked on. Each reflects my passion for solving real-world problems through technology.
      </p>
          ...
          >
            <div className="relative h-28 w-full overflow-hidden">
              <Image
                ...
                alt={project.title}
                fill
                className="object-cover transition duration-300 group-hover:opacity-30"
                unoptimized // needed if using public assets without next/image optimization
              />
